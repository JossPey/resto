...
<ul class="gallery">
        <li><img src="./assets/images/fondue.jpg" alt=""></li>
        <li><img src="./assets/images/image1.jpg" alt=""></li>
        <li><img src="./assets/images/image2.jpg" alt=""></li>
        <li><img src="./assets/images/image3.jpg" alt=""></li>
        <li><img src="./assets/images/image4.jpg" alt=""></li>
        ...
        <li><img src="./assets/images/image17.jpg" alt=""></li>
        <li><img src="./assets/images/image18.jpg" alt=""></li>
        <li><img src="./assets/images/image19.jpg" alt=""></li>
